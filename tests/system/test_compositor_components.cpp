...
#include "system/compositor/double_inset_border.hpp"
...
#include "system/compositor/mobile_launch_backdrop.hpp"
#include "system/compositor/popup_surface_geometry.hpp"
...
#include "system/render/dma_buf_crop.hpp"
#include "system/render/raster_destination.hpp"
...
TEST(MobileLaunchBackdropTest, UsesScaleAndBrightnessWithoutEffectOpacity) {
    ...
    EXPECT_FLOAT_EQ(start.dimmingOpacity, 0.0f);
    ...
    EXPECT_NEAR(halfway.dimmingOpacity, 0.09f, 0.0001f);
    ...
    EXPECT_NEAR(covered.dimmingOpacity, 0.18f, 0.0001f);
}
