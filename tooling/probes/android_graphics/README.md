...
Place the pulled probe libraries in `out/tools/android-graphics-probe-libs/`.
Override that location with `-DLCL_ANDROID_PROBE_LIB_DIR=...` when needed.

```bash
export ANDROID_NDK="/home/superb/Android/Sdk/ndk/28.2.13676358"

cmake -B ../../../out/tools/android-graphics-probe -S . \
      -DCMAKE_TOOLCHAIN_FILE="$ANDROID_NDK/build/cmake/android.toolchain.cmake" \
      -DANDROID_ABI=x86_64 \
      -DANDROID_PLATFORM=android-35 \
      -DCMAKE_BUILD_TYPE=Release

cmake --build ../../../out/tools/android-graphics-probe
```

## Running on AVD
```bash
adb push ../../../out/tools/android-graphics-probe/android_graphics_probe /data/local/tmp/
