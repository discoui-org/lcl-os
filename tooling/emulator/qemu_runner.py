...
from tooling.paths import QEMU_CACHE_DIR, ROOTFS_DIR, qemu_build_dir

RUN_QEMU = ROOT_DIR / "tooling" / "emulator" / "run_qemu.py"
REQUIRED_ARTIFACTS = (
    QEMU_CACHE_DIR / "vmlinuz",
    qemu_build_dir("x86_64") / "initramfs.cpio.gz",
    ROOTFS_DIR / "lcl-rootfs-x86_64.ext4",
)
