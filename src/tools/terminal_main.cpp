...
static uint8_t getSimpleGlyphRow(char c, int row) {
  ...
  if (c >= '0' && c <= '9') {
    static const uint8_t digits[10][16] = {
        ...
        {0x00, 0x00, 0x3C, 0x66, 0x06, 0x1C, 0x06, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x0C, 0x1C, 0x3C, 0x6C, 0xFE, 0x0C, 0x1E, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x7E, 0x60, 0x7C, 0x06, 0x06, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x7E, 0x66, 0x0C, 0x18, 0x18, 0x18, 0x18, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x66, 0x66, 0x3C, 0x66, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x66, 0x66, 0x3E, 0x06, 0x06, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00}};
  ...
  if (c >= 'A' && c <= 'Z') {
    static const uint8_t upper[26][16] = {
        {0x00, 0x00, 0x10, 0x38, 0x6C, 0xC6, 0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0xC6,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xFC, 0x66, 0x66, 0x7C, 0x66, 0x66, 0x66, 0xFC, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x66, 0xC0, 0xC0, 0xC0, 0xC0, 0x66, 0x3C, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xF8, 0x6C, 0x66, 0x66, 0x66, 0x66, 0x6C, 0xF8, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xFE, 0x62, 0x68, 0x78, 0x68, 0x62, 0xFE, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xFE, 0x62, 0x68, 0x78, 0x68, 0x60, 0xF0, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x66, 0xC0, 0xC0, 0xCE, 0xC6, 0x66, 0x3E, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0xC6, 0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0xC6, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x1E, 0x0C, 0x0C, 0x0C, 0x0C, 0xCC, 0xCC, 0x78, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xE6, 0x66, 0x6C, 0x78, 0x6C, 0x66, 0xE6, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xF0, 0x60, 0x60, 0x60, 0x60, 0x62, 0xFE, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0xEE, 0xFE, 0xD6, 0xC6, 0xC6, 0xC6, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        ...
        {0x00, 0x00, 0xFC, 0x66, 0x66, 0x7C, 0x60, 0x60, 0xF0, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x38, 0x6C, 0xC6, 0xC6, 0xC6, 0xDA, 0xCC, 0x76, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xFC, 0x66, 0x66, 0x7C, 0x6C, 0x66, 0xE6, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x3E, 0x66, 0x60, 0x3C, 0x06, 0x66, 0x7C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0xC6, 0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0xC6, 0xC6, 0xC6, 0x6C, 0x38, 0x10, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0xC6, 0xC6, 0xD6, 0xFE, 0xEE, 0xC6, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xC6, 0x6C, 0x38, 0x38, 0x6C, 0xC6, 0x00, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0xFE, 0x06, 0x0C, 0x18, 0x30, 0x60, 0xFE, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00}};
    return upper[c - 'A'][row];
  }
  if (c >= 'a' && c <= 'z') {
    static const uint8_t lower[26][16] = {
        {0x00, 0x00, 0x00, 0x3C, 0x06, 0x3E, 0x66, 0x66, 0x3F, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        ...
        {0x00, 0x00, 0x18, 0x00, 0x38, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x06, 0x00, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        ...
        {0x00, 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x00, 0x7C, 0x66, 0x66, 0x7C, 0x60, 0xF0, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x00, 0x3E, 0x66, 0x66, 0x3E, 0x06, 0x0F, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x00, 0x5C, 0x66, 0x60, 0x60, 0x60, 0xF0, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x00, 0x3E, 0x60, 0x3C, 0x06, 0x66, 0x7C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        ...
        {0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x00, 0xC6, 0xC6, 0xD6, 0xFE, 0xEE, 0x6C, 0x00, 0x00, 0x00,
         0x00, 0x00, 0x00, 0x00},
  ...
  case '/':
    return uint8_t(
        "\x00\x00\x02\x06\x0C\x18\x30\x60\x40\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case ':':
    return uint8_t(
        "\x00\x00\x00\x18\x18\x00\x18\x18\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '$':
    return uint8_t(
        "\x00\x18\x3E\x68\x3C\x0B\x7C\x18\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '#':
    return uint8_t(
        "\x00\x24\x24\x7E\x24\x7E\x24\x24\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '-':
    return uint8_t(
        "\x00\x00\x00\x00\x7E\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '_':
    return uint8_t(
  ...
  case '.':
    return uint8_t(
        "\x00\x00\x00\x00\x00\x18\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '@':
    return uint8_t(
        "\x00\x00\x3C\x66\x6E\x6E\x6E\x60\x3E\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '~':
    return uint8_t(
        "\x00\x00\x00\x00\x6C\x36\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  case '%':
    return uint8_t(
        "\x00\x00\x62\x64\x08\x10\x26\x46\x00\x00\x00\x00\x00\x00\x00\x00"
            [row]);
  default:
    return 0x00;
  }
...
static void renderTerminalFrame(uint32_t *shmPixels, int width, int height,
  ...
  int fontCellW =
      fontRenderer.isInitialized() ? fontRenderer.getCellWidth() : 8;
  int fontCellH =
      fontRenderer.isInitialized() ? fontRenderer.getCellHeight() : 16;
  ...
  for (size_t l = startLine;
    ...
    if (!line.empty()) {
      if (fontRenderer.isInitialized()) {
        ...
        drawFallbackString(shmPixels, width, height, pad, curY, line,
                           kTextColor);
      }
    }
    curY += lineSpacing;
  ...
  int caretX = pad + (fontRenderer.isInitialized()
                          ? fontRenderer.getTextWidth(caretPrefix)
                          : caretCol * fontCellW);
...
int main() {
  ...
  std::vector<lcl::protocol::FilterOp> termFilters = {
      {lcl::protocol::FilterType::Blur, 40.0f},
  ...
  filterHeader.payloadSize =
      sizeof(lcl::protocol::LCLMsgSetBackdropFilterHeader) +
      termFilters.size() * sizeof(lcl::protocol::FilterOp);

  std::vector<uint8_t> filterPayload(filterHeader.payloadSize);
  auto *filterMsgHeader =
      reinterpret_cast<lcl::protocol::LCLMsgSetBackdropFilterHeader *>(
          filterPayload.data());
  filterMsgHeader->surfaceId = 1;
  filterMsgHeader->filterCount = static_cast<uint32_t>(termFilters.size());

  std::memcpy(filterPayload.data() +
                  sizeof(lcl::protocol::LCLMsgSetBackdropFilterHeader),
              termFilters.data(),
              termFilters.size() * sizeof(lcl::protocol::FilterOp));

  lcl::protocol::sendMsgWithFd(socketFd, filterHeader, filterPayload.data());
  std::cout << "[LCL Terminal] Set Backdrop Filter pipeline (Blur: 12px, "
               "Saturation: 1.2, Brightness: 0.95).\n";
