...
binder_status_t HardwareBuffer::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &description);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t HardwareBuffer::writeToParcel(AParcel* _aidl_parcel) const {
  binder_status_t _aidl_ret_status;
  int32_t _aidl_start_pos = AParcel_getDataPosition(_aidl_parcel);
  _aidl_ret_status = AParcel_writeInt32(_aidl_parcel, 0);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, description);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
