...
namespace graphics {
namespace composer3 {
const char* ReleaseFences::descriptor = "android.hardware.graphics.composer3.ReleaseFences";

binder_status_t ReleaseFences::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t ReleaseFences::writeToParcel(AParcel* _aidl_parcel) const {
...
namespace graphics {
namespace composer3 {
const char* ReleaseFences::Layer::descriptor = "android.hardware.graphics.composer3.ReleaseFences.Layer";

binder_status_t ReleaseFences::Layer::readFromParcel(const AParcel* _aidl_parcel) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  int32_t _aidl_start_pos = AParcel_getDataPosition(_aidl_parcel);
  int32_t _aidl_parcelable_size = 0;
  _aidl_ret_status = AParcel_readInt32(_aidl_parcel, &_aidl_parcelable_size);
...
binder_status_t ReleaseFences::Layer::writeToParcel(AParcel* _aidl_parcel) const {
  binder_status_t _aidl_ret_status;
  int32_t _aidl_start_pos = AParcel_getDataPosition(_aidl_parcel);
  _aidl_ret_status = AParcel_writeInt32(_aidl_parcel, 0);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
