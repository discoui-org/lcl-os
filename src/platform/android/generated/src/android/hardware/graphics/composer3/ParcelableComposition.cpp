...
namespace graphics {
namespace composer3 {
const char* ParcelableComposition::descriptor = "android.hardware.graphics.composer3.ParcelableComposition";

binder_status_t ParcelableComposition::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t ParcelableComposition::writeToParcel(AParcel* _aidl_parcel) const {
