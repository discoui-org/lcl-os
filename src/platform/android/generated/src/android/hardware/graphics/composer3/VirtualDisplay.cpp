...
namespace graphics {
namespace composer3 {
const char* VirtualDisplay::descriptor = "android.hardware.graphics.composer3.VirtualDisplay";

binder_status_t VirtualDisplay::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t VirtualDisplay::writeToParcel(AParcel* _aidl_parcel) const {
