 ...
 * Using: /home/superb/Android/Sdk/build-tools/36.1.0/aidl --lang=ndk --structured --stability=vintf -I /tmp/lcl_aidl_gen_avdNoa/composer -I /tmp/lcl_aidl_gen_avdNoa/graphics_common -I /tmp/lcl_aidl_gen_avdNoa/common -I /tmp/lcl_aidl_gen_avdNoa/drm_common -h /tmp/lcl_aidl_gen_avdNoa/out_inc -o /tmp/lcl_aidl_gen_avdNoa/out_src /tmp/lcl_aidl_gen_avdNoa/graphics_common/android/hardware/graphics/common/Dataspace.aidl
 *
...
enum class Dataspace : int32_t {
  ...
  ADOBE_RGB = 151715840,
  ADOBE_RGB_LINEAR = 139132928,
  BT2020_LINEAR = 138805248,
  BT2020 = 147193856,
  BT2020_PQ = 163971072,
  BT2020_LINEAR_EXTENDED = 407240704,
  DEPTH = 4096,
  SENSOR = 4097,
...
[[nodiscard]] static inline std::string toString(Dataspace val) {
  ...
  case Dataspace::ADOBE_RGB:
    return "ADOBE_RGB";
  case Dataspace::ADOBE_RGB_LINEAR:
  ...
  case Dataspace::BT2020_PQ:
    return "BT2020_PQ";
  case Dataspace::BT2020_LINEAR_EXTENDED:
    return "BT2020_LINEAR_EXTENDED";
  ...
  case Dataspace::JPEG_R:
    return "JPEG_R";
  case Dataspace::HEIF_ULTRAHDR:
    return "HEIF_ULTRAHDR";
...
template <>
constexpr inline std::array<aidl::android::hardware::graphics::common::Dataspace, 64> enum_values<aidl::android::hardware::graphics::common::Dataspace> = {
  ...
  aidl::android::hardware::graphics::common::Dataspace::ADOBE_RGB_LINEAR,
  ...
  aidl::android::hardware::graphics::common::Dataspace::BT2020_LINEAR_EXTENDED,
