...
- **IPC & Disconnects:** Protocol-v27 compositor `SOCK_SEQPACKET` plus central `lcl-rasterd`; only rasterd's private channel publishes ready layer FDs. Socket EOF automatically triggers surface/window reclamation.
