...
def main() -> None:
    ...
    parser.add_argument("--cache", type=Path, default=Path("build/android-hidl-generator"))
    parser.add_argument(
        "--output", type=Path,
        default=Path("src/platform/android/hidl_generated/include"),
    )
    ...
    (output.parent / "PROVENANCE.md").write_text(
        ...
        "`tools/generate_android_hidl.py`.\n\n"
        "Inputs:\n"
        "- https://android.googlesource.com/platform/hardware/interfaces\n"
        "- https://android.googlesource.com/platform/system/libhidl\n"
        "- https://android.googlesource.com/platform/prebuilts/build-tools\n",
