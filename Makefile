...
qemu:
	python3 scripts/run_qemu.py --run $(QEMU_NATIVE_FLAG) $(QEMU_GPU_FLAG) $(QEMU_RETINA_FLAG) $(QEMU_SCALE_FLAG) $(QEMU_WIDTH_FLAG) $(QEMU_HEIGHT_FLAG) $(QEMU_USB_FLAG)

iso:
	./scripts/build_iso.sh

qemu-iso: iso
	python3 scripts/run_qemu.py --iso --run $(QEMU_NATIVE_FLAG) $(QEMU_GPU_FLAG) $(QEMU_UEFI_FLAG) $(QEMU_RETINA_FLAG) $(QEMU_SCALE_FLAG) $(QEMU_WIDTH_FLAG) $(QEMU_HEIGHT_FLAG) $(QEMU_USB_FLAG)
