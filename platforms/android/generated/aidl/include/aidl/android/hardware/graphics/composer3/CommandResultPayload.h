 ...
 * Using: /home/superb/Android/Sdk/build-tools/36.1.0/aidl --lang=ndk --structured --stability=vintf -I /tmp/lcl_aidl_gen_avdNoa/composer -I /tmp/lcl_aidl_gen_avdNoa/graphics_common -I /tmp/lcl_aidl_gen_avdNoa/common -I /tmp/lcl_aidl_gen_avdNoa/drm_common -h /tmp/lcl_aidl_gen_avdNoa/out_inc -o /tmp/lcl_aidl_gen_avdNoa/out_src /tmp/lcl_aidl_gen_avdNoa/composer/android/hardware/graphics/composer3/CommandResultPayload.aidl
 *
...
public:
  ...
  static const inline Tag displayLuts = Tag::displayLuts;
  ...
  inline bool operator==(const CommandResultPayload& _rhs) const {
  ...
  inline std::string toString() const {
    ...
    case displayLuts: os << "displayLuts: " << ::android::internal::ToString(get<displayLuts>()); break;
    }
    os << "}";
    return os.str();
  }
private:
  std::variant<::aidl::android::hardware::graphics::composer3::CommandError, ::aidl::android::hardware::graphics::composer3::ChangedCompositionTypes, ::aidl::android::hardware::graphics::composer3::DisplayRequest, ::aidl::android::hardware::graphics::composer3::PresentFence, ::aidl::android::hardware::graphics::composer3::ReleaseFences, ::aidl::android::hardware::graphics::composer3::PresentOrValidate, ::aidl::android::hardware::graphics::composer3::ClientTargetPropertyWithBrightness, ::aidl::android::hardware::graphics::composer3::DisplayLuts> _value;
};
}  // namespace composer3
}  // namespace graphics
}  // namespace hardware
...
template <>
constexpr inline std::array<aidl::android::hardware::graphics::composer3::CommandResultPayload::Tag, 8> enum_values<aidl::android::hardware::graphics::composer3::CommandResultPayload::Tag> = {
  ...
  aidl::android::hardware::graphics::composer3::CommandResultPayload::Tag::displayLuts,
};
