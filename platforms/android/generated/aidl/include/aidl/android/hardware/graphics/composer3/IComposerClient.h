...
class ReadbackBufferAttributes;
...
namespace graphics {
namespace composer3 {
class IComposerClientDelegator;

class IComposerClient : public ::ndk::ICInterface {
public:
  typedef IComposerClientDelegator DefaultDelegator;
  ...
  enum : int32_t { EX_CONFIG_FAILED = 11 };
  enum : int32_t { EX_PICTURE_PROFILE_MAX_EXCEEDED = 12 };
  ...
  static constexpr uint32_t TRANSACTION_getOverlaySupport = FIRST_CALL_TRANSACTION + 41;
  static constexpr uint32_t TRANSACTION_getHdrConversionCapabilities = FIRST_CALL_TRANSACTION + 42;
  static constexpr uint32_t TRANSACTION_setHdrConversionStrategy = FIRST_CALL_TRANSACTION + 43;
  static constexpr uint32_t TRANSACTION_setRefreshRateChangedCallbackDebugEnabled = FIRST_CALL_TRANSACTION + 44;
  static constexpr uint32_t TRANSACTION_getDisplayConfigurations = FIRST_CALL_TRANSACTION + 45;
  static constexpr uint32_t TRANSACTION_notifyExpectedPresent = FIRST_CALL_TRANSACTION + 46;
  static constexpr uint32_t TRANSACTION_getMaxLayerPictureProfiles = FIRST_CALL_TRANSACTION + 47;
  static constexpr uint32_t TRANSACTION_startHdcpNegotiation = FIRST_CALL_TRANSACTION + 48;
  static constexpr uint32_t TRANSACTION_getLuts = FIRST_CALL_TRANSACTION + 49;
  ...
  virtual ::ndk::ScopedAStatus getDisplayConfigs(int64_t in_display, std::vector<int32_t>* _aidl_return) __attribute__((deprecated("use getDisplayConfigurations instead. For legacy support getDisplayConfigs should return at least one valid config. All the configs returned from the getDisplayConfigs should also be returned from getDisplayConfigurations."))) = 0;
  ...
  virtual ::ndk::ScopedAStatus getOverlaySupport(::aidl::android::hardware::graphics::composer3::OverlayProperties* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus getHdrConversionCapabilities(std::vector<::aidl::android::hardware::graphics::common::HdrConversionCapability>* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus setHdrConversionStrategy(const ::aidl::android::hardware::graphics::common::HdrConversionStrategy& in_conversionStrategy, ::aidl::android::hardware::graphics::common::Hdr* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus setRefreshRateChangedCallbackDebugEnabled(int64_t in_display, bool in_enabled) = 0;
  virtual ::ndk::ScopedAStatus getDisplayConfigurations(int64_t in_display, int32_t in_maxFrameIntervalNs, std::vector<::aidl::android::hardware::graphics::composer3::DisplayConfiguration>* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus notifyExpectedPresent(int64_t in_display, const ::aidl::android::hardware::graphics::composer3::ClockMonotonicTimestamp& in_expectedPresentTime, int32_t in_frameIntervalNs) = 0;
  virtual ::ndk::ScopedAStatus getMaxLayerPictureProfiles(int64_t in_display, int32_t* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus startHdcpNegotiation(int64_t in_display, const ::aidl::android::hardware::drm::HdcpLevels& in_levels) = 0;
  virtual ::ndk::ScopedAStatus getLuts(int64_t in_display, const std::vector<::aidl::android::hardware::graphics::composer3::Buffer>& in_buffers, std::vector<::aidl::android::hardware::graphics::composer3::Luts>* _aidl_return) = 0;
private:
