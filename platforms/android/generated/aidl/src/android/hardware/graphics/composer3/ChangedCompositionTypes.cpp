...
namespace graphics {
namespace composer3 {
const char* ChangedCompositionTypes::descriptor = "android.hardware.graphics.composer3.ChangedCompositionTypes";

binder_status_t ChangedCompositionTypes::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t ChangedCompositionTypes::writeToParcel(AParcel* _aidl_parcel) const {
