...
namespace graphics {
namespace common {
const char* Point::descriptor = "android.hardware.graphics.common.Point";

binder_status_t Point::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Point::writeToParcel(AParcel* _aidl_parcel) const {
