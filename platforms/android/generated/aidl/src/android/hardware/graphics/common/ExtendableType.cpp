...
namespace graphics {
namespace common {
const char* ExtendableType::descriptor = "android.hardware.graphics.common.ExtendableType";

binder_status_t ExtendableType::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t ExtendableType::writeToParcel(AParcel* _aidl_parcel) const {
