...
namespace graphics {
namespace common {
const char* DisplayDecorationSupport::descriptor = "android.hardware.graphics.common.DisplayDecorationSupport";

binder_status_t DisplayDecorationSupport::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &alphaInterpretation);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t DisplayDecorationSupport::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, alphaInterpretation);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
