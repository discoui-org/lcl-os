...
namespace graphics {
namespace common {
const char* PlaneLayoutComponent::descriptor = "android.hardware.graphics.common.PlaneLayoutComponent";

binder_status_t PlaneLayoutComponent::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &offsetInBits);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &sizeInBits);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t PlaneLayoutComponent::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, offsetInBits);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, sizeInBits);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
