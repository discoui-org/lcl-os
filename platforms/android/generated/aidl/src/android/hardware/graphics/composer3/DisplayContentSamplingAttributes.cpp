...
namespace graphics {
namespace composer3 {
const char* DisplayContentSamplingAttributes::descriptor = "android.hardware.graphics.composer3.DisplayContentSamplingAttributes";

binder_status_t DisplayContentSamplingAttributes::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &componentMask);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t DisplayContentSamplingAttributes::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, componentMask);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
