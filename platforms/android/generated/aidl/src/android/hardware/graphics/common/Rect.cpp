...
namespace graphics {
namespace common {
const char* Rect::descriptor = "android.hardware.graphics.common.Rect";

binder_status_t Rect::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Rect::writeToParcel(AParcel* _aidl_parcel) const {
